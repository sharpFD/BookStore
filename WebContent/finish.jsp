...
<body>
    ...
    <div class="content">
    	<div class="contentCenter">
    			...
    			<div class="twoDiv">
					...
					<ul class="oneUL">
    					<li>
    						...
    						<%
    						if(evaluate!=null){
    						if(evaluate.getState()==0){ flag=true;
    		...
    		<div class="submit">
    			<%if(flag==true){ //存在未评价的%>
    			<span>已付金额：<font>¥<%out.print(f1); %></font><img src="images/21_13.png" alt="" onclick="checkForm2()"></span>
    			<%} else{%>
    			<span>已付金额：<font>¥<%out.print(f1); %></font><img src="images/21_05.png" alt="" onclick="checkForm2()"></span>
    			<%} %>
    		</div>
    	</div>
