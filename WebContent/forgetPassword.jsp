...
<body>
    ...
    <div class="header3">
    	...
    	<div class="h3_center">
            ...
            {
            %>
          	    <a href="list.jsp?type=<% out.print(list.get(i).getId());%> "> <% out.print(list.get(i).getName()); %> </a>|
          	    <%} %>
            </p>
        </div>
        <div class="h3_right">
    ...
    <div class="nav_top">
    	<div class="nav_top_center">
            ...
            {
            %>
                <li><a href="list.jsp?type=<% out.print(list.get(i).getId());%>"><% out.print(list.get(i).getName()); %></a></li>
                <%} %>
            </ul>
        </div>
    </div>
    <div class="container4">
    	<div class="register_box">
    			...
    			<div class="security">
    				...
    				<form action="forgetPassword1.html" method="post">
    					<ul class="list">
    						<li>
    						...
    						<span class="code">
    							<img id="J_imgVcode" title="点击更换验证码" src="imageServlet" alt="点击更换验证码" height="38" width="85"/>
    						</span>
    						<a id="J_vcodeImgBtn" class="more" href="forgetPassword.html">换一张</a>
