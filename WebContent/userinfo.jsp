...
<body>
    ...
    <!--头部-->
     <div class="header3">
    	...
    	<div class="h3_center">
            ...
            {
            %>
          	    <a href="?type=<% out.print(list.get(i).getId());%> "> <% out.print(list.get(i).getName()); %> </a>|
          	    <%} %>
            </p>
        </div>
        <div class="h3_right">
    ...
    <div class="nav_top">
    	<div class="nav_top_center">
            ...
            {
            %>
                <li><a href="?type=<% out.print(list.get(i).getId());%>"><% out.print(list.get(i).getName()); %></a></li>
                <%} %>
            </ul>
        </div>
    </div>
    	...
    	<div class="register_box">
    			...
    			<div class="security">
    				<form action="UpdateUserServlet">
    					<ul class="list">
    						<li>
    								<input id="J_euserName" class="long" readonly="readonly" name="name" value=<%out.print(PageJumpUtils.getUserByreq(request).getName());%>  type="text" />
